...
int main() {
  ...
  assert(strcmp(node->data.text.font, "Times New Roman") == 0);
  assert(fabsf(node->data.text.font_size - 27.5f) < 0.00001f);
  assert(node->data.text.is_bold == true);
  ...
  assert(strcmp(node->data.text.font, "Times New Roman") == 0);
  assert(fabsf(node->data.text.font_size - 21.5f) < 0.00001f);
  assert(node->data.text.is_bold == true);
  ...
  assert(strcmp(node->data.text.font, "Times New Roman") == 0);
  assert(fabsf(node->data.text.font_size - 18.5f) < 0.00001f);
  assert(node->data.text.is_bold == true);
  ...
  assert(strcmp(node->data.text.font, "Times New Roman") == 0);
  assert(fabsf(node->data.text.font_size - 15.5f) < 0.00001f);
  assert(node->data.text.is_bold == true);
  ...
  assert(strcmp(node->data.text.font, "Times New Roman") == 0);
  assert(fabsf(node->data.text.font_size - 12.0f) < 0.00001f);
  assert(node->data.text.is_bold == true);
